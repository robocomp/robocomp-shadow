...
RoboCompLidar3D::Lidar3D::_iceD_getLidarData(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    int iceP_start;
    int iceP_len;
    istr->readAll(iceP_start, iceP_len);
    inS.endReadParams();
    TLidarData ret = this->getLidarData(iceP_start, iceP_len, current);
...
/// \cond INTERNAL
void
RoboCompLidar3D::Lidar3DPrx::_iceI_getLidarData(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::RoboCompLidar3D::TLidarData>>& outAsync, int iceP_start, int iceP_len, const ::Ice::Context& context)
{
    ...
    outAsync->invoke(iceC_RoboCompLidar3D_Lidar3D_getLidarData_name, ::Ice::OperationMode::Normal, ::Ice::FormatType::DefaultFormat, context,
        ...
        {
            ostr->writeAll(iceP_start, iceP_len);
        },
        nullptr);
}
/// \endcond
...
::Ice::AsyncResultPtr
IceProxy::RoboCompLidar3D::Lidar3D::_iceI_begin_getLidarData(::Ice::Int iceP_start, ::Ice::Int iceP_len, const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
...
IceProxy::RoboCompLidar3D::Lidar3D::end_getLidarData(const ::Ice::AsyncResultPtr& result)
{
    ...
    ::RoboCompLidar3D::TLidarData ret;
