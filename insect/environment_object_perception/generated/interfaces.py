...
Ice.loadSlice("-I ./generated/ --all ./generated/VisualElementsPub.ice")
...
class Publishes:
    def __init__(self, ice_connector:Ice.CommunicatorI, topic_manager, parameters):
        ...
        self.visualelementspub = self.create_topic("VisualElementsPub", "VisualElementsPub", parameters["Proxies"]["VisualElementsPubPrefix"], RoboCompVisualElementsPub.VisualElementsPubPrx)
