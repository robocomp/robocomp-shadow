...
class SpecificWorker : public GenericWorker
{
    ...
    private:
        ...
        // double sync buffer
        BufferSync<InOut<RoboCompCamera360RGB::TImage, RoboCompCamera360RGB::TImage>,
                   InOut<RoboCompLidar3D::TDataImage, RoboCompLidar3D::TDataImage>> buffer_sync{10};
        BufferSync<InOut<cv::Mat, cv::Mat>, InOut<cv::Mat, cv::Mat>> buffer_transfer;
