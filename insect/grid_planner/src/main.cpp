...
/** \mainpage RoboComp::grid_planner
 *
 * \section intro_sec Introduction
 *
 * The grid_planner component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/grid_planner --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class grid_planner : public RoboComp::Application
{
public:
	grid_planner (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::grid_planner::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::grid_planner app(prefix, startup_check_flag);
