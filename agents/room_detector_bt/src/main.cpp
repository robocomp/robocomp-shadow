...
/** \mainpage RoboComp::room_detector_bt
 *
 * \section intro_sec Introduction
 *
 * The room_detector_bt component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/room_detector_bt --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class room_detector_bt : public RoboComp::Application
{
public:
	room_detector_bt (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::room_detector_bt::initialize()
{
...
int ::room_detector_bt::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::room_detector_bt app(prefix, startup_check_flag);
