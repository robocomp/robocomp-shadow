...
/** \mainpage RoboComp::shadow_agent
 *
 * \section intro_sec Introduction
 *
 * The shadow_agent component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/shadow_agent --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "shadow_agent"
#define SERVER_FULL_NAME   "RoboComp shadow_agent::shadow_agent"


class shadow_agent : public Ice::Application
{
public:
	shadow_agent (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData shadow_agent::getInitializationDataIce(){
...
void shadow_agent::initialize()
{
    this->configLoader.load(this->configFile);
	this->configLoader.printConfig();
}

int shadow_agent::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	shadow_agent app(configFile, prefix, startup_check_flag);
