...
/** \mainpage RoboComp::intention_prediction_agent
 *
 * \section intro_sec Introduction
 *
 * The intention_prediction_agent component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/intention_prediction_agent --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class intention_prediction_agent : public RoboComp::Application
{
public:
	intention_prediction_agent (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::intention_prediction_agent::initialize()
{
...
int ::intention_prediction_agent::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::intention_prediction_agent app(prefix, startup_check_flag);
