...
/** \mainpage RoboComp::people_bridge_agent
 *
 * \section intro_sec Introduction
 *
 * The people_bridge_agent component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/people_bridge_agent --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class people_bridge_agent : public RoboComp::Application
{
public:
	people_bridge_agent (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::people_bridge_agent::initialize()
{
...
int ::people_bridge_agent::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::people_bridge_agent app(prefix, startup_check_flag);
