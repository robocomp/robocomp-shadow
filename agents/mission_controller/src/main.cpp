...
class mission_controller : public RoboComp::Application
{
public:
	mission_controller (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int main(int argc, char* argv[])
{
	...
	::mission_controller app(prefix, startup_check_flag);
