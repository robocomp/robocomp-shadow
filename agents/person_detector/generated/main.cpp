...
/** \mainpage RoboComp::person_detector
 *
 * \section intro_sec Introduction
 *
 * The person_detector component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/person_detector --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "person_detector"
#define SERVER_FULL_NAME   "RoboComp person_detector::person_detector"
...
class person_detector : public Ice::Application
{
public:
	person_detector (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData person_detector::getInitializationDataIce(){
...
void person_detector::initialize()
{
...
int person_detector::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	person_detector app(configFile, prefix, startup_check_flag);
