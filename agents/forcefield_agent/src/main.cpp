...
/** \mainpage RoboComp::forcefield_agent
 *
 * \section intro_sec Introduction
 *
 * The forcefield_agent component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/forcefield_agent --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class forcefield_agent : public RoboComp::Application
{
public:
	forcefield_agent (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::forcefield_agent::initialize()
{
...
int ::forcefield_agent::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::forcefield_agent app(prefix, startup_check_flag);
