...
class door_detector : public RoboComp::Application
{
public:
	door_detector (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int main(int argc, char* argv[])
{
	...
	::door_detector app(prefix, startup_check_flag);
