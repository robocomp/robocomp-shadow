...
Like any other component, gtsam_agent_c requires a configuration file to start. In etc/config or etc/config.toml, you can find an example of the configuration file.
...
bin/gtsam_agent_c etc/yourConfig # Execute the component
```
-----
-----
# Developer Notes
This section explains how to work with the generated code of gtsam_agent_c, including what can be modified and how to use key features.
## Editable Files
