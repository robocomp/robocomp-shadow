...
/** \mainpage RoboComp::gtsam_agent_c
 *
 * \section intro_sec Introduction
 *
 * The gtsam_agent_c component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/gtsam_agent_c --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "gtsam_agent_c"
#define SERVER_FULL_NAME   "RoboComp gtsam_agent_c::gtsam_agent_c"
...
class gtsam_agent_c : public Ice::Application
{
public:
	gtsam_agent_c (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData gtsam_agent_c::getInitializationDataIce(){
...
int gtsam_agent_c::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	gtsam_agent_c app(configFile, prefix, startup_check_flag);
