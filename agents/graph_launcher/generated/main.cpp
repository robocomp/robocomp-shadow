...
/** \mainpage RoboComp::graph_launcher
 *
 * \section intro_sec Introduction
 *
 * The graph_launcher component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/graph_launcher --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "graph_launcher"
#define SERVER_FULL_NAME   "RoboComp graph_launcher::graph_launcher"



class graph_launcher : public Ice::Application
{
public:
	graph_launcher (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData graph_launcher::getInitializationDataIce(){
...
void graph_launcher::initialize()
{
...
int graph_launcher::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	graph_launcher app(configFile, prefix, startup_check_flag);
