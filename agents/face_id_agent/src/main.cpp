...
/** \mainpage RoboComp::face_id_agent
 *
 * \section intro_sec Introduction
 *
 * The face_id_agent component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/face_id_agent --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class face_id_agent : public RoboComp::Application
{
public:
	face_id_agent (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::face_id_agent::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::face_id_agent app(prefix, startup_check_flag);
