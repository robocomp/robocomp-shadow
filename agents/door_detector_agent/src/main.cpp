...
/** \mainpage RoboComp::door_detector_agent
 *
 * \section intro_sec Introduction
 *
 * The door_detector_agent component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/door_detector_agent --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class door_detector_agent : public RoboComp::Application
{
public:
	door_detector_agent (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::door_detector_agent::initialize()
{
...
int ::door_detector_agent::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::door_detector_agent app(prefix, startup_check_flag);
