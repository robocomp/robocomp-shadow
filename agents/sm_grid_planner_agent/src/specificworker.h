...
class SpecificWorker : public GenericWorker
{
    ...
    private:
        ...
        // Draw
        void draw_scenario(const vector<Eigen::Vector3f> &points, QGraphicsScene *scene);
        ...
        void draw_lidar(const std::vector<Eigen::Vector3f> &points, int decimate, QGraphicsScene *scene);
