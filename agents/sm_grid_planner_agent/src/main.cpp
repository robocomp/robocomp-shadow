...
/** \mainpage RoboComp::sm_grid_planner_agent
 *
 * \section intro_sec Introduction
 *
 * The sm_grid_planner_agent component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/sm_grid_planner_agent --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class sm_grid_planner_agent : public RoboComp::Application
{
public:
	sm_grid_planner_agent (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::sm_grid_planner_agent::initialize()
{
...
int ::sm_grid_planner_agent::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::sm_grid_planner_agent app(prefix, startup_check_flag);
