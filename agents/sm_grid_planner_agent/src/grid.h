...
public:
        ...
        inline Key point_to_key_base(double x, double y) const; // base method
        inline Key point_to_key(long int x, long int z) const;
        inline Key point_to_key(const QPointF &p) const;
        inline Key point_to_key(const Eigen::Vector2f &p) const;
