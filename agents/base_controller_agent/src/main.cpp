...
class base_controller_agent : public RoboComp::Application
{
public:
	base_controller_agent (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int main(int argc, char* argv[])
{
	...
	::base_controller_agent app(prefix, startup_check_flag);
