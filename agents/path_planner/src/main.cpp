...
/** \mainpage RoboComp::path_planner
 *
 * \section intro_sec Introduction
 *
 * The path_planner component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/path_planner --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class path_planner : public RoboComp::Application
{
public:
	path_planner (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::path_planner::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::path_planner app(prefix, startup_check_flag);
