 ...
 *
 * Just: "${PATH_TO_BINARY}/scheduler --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class scheduler : public RoboComp::Application
{
public:
	scheduler (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::scheduler::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::scheduler app(prefix, startup_check_flag);
