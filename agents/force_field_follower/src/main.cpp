...
/** \mainpage RoboComp::force_field_follower
 *
 * \section intro_sec Introduction
 *
 * The force_field_follower component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/force_field_follower --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class force_field_follower : public RoboComp::Application
{
public:
	force_field_follower (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::force_field_follower::initialize()
{
...
int ::force_field_follower::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::force_field_follower app(prefix, startup_check_flag);
