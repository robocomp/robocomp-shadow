...
class Publishes:
    def __init__(self, ice_connector:Ice.CommunicatorI, topic_manager, parameters):
        ...
        self.fullposeestimationpub = self.create_topic("FullPoseEstimationPub", "FullPoseEstimationPub", parameters["Proxies"]["FullPoseEstimationPubPrefix"], RoboCompFullPoseEstimationPub.FullPoseEstimationPubPrx)
