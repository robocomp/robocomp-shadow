...
//            qDebug() << "Past corner" << q_past.x() << q_past.y();
        ...
        //Create robot pose in 3D
        robot_pose_3d = Eigen::Translation3d(robot_pose.translation().x(), robot_pose.translation().y(), 0.0) * Eigen::AngleAxisd(angle, Eigen::Vector3d::UnitZ());
    ...
    Eigen::Affine3d ActionableRoom::get_robot_pose_3d() const
    {
        return robot_pose_3d;
    }
