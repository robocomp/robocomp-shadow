...
/** \mainpage RoboComp::table_detector
 *
 * \section intro_sec Introduction
 *
 * The table_detector component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/table_detector --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class table_detector : public RoboComp::Application
{
public:
	table_detector (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::table_detector::initialize()
{
...
int ::table_detector::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::table_detector app(prefix, startup_check_flag);
