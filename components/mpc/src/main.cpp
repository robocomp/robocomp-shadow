 ...
 *
 * Just: "${PATH_TO_BINARY}/MPC --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class MPC : public RoboComp::Application
{
public:
	MPC (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::MPC::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::MPC app(prefix, startup_check_flag);
