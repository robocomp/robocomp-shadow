...
Ice.loadSlice("-I ./generated/ --all ./generated/IMU.ice")
import RoboCompIMU
Ice.loadSlice("-I ./generated/ --all ./generated/IMUPub.ice")
import RoboCompIMUPub
Ice.loadSlice("-I ./generated/ --all ./generated/MediaPlaneDDS.ice")
import RoboCompMediaPlaneDDS


import imuI
import mediaplaneddsI
...
class Publishes:
    def __init__(self, ice_connector:Ice.CommunicatorI, topic_manager, parameters):
        ...
        self.imupub = self.create_topic("IMUPub", "IMUPub", parameters["Proxies"]["IMUPubPrefix"], RoboCompIMUPub.IMUPubPrx)
...
class Requires:
    def __init__(self, ice_connector:Ice.CommunicatorI, parameters):
        ...
        self.IMU = self.create_proxy("IMU", RoboCompIMU.IMUPrx, parameters["Proxies"]["IMU"])
...
class Implements:
    def __init__(self, ice_connector:Ice.CommunicatorI, default_handler, parameters):
        ...
        self.imu = self.create_adapter("IMU", imuI.IMUI(default_handler, ""), parameters["Endpoints"]["IMU"])
        self.mediaplanedds = self.create_adapter("MediaPlaneDDS", mediaplaneddsI.MediaPlaneDDSI(default_handler, ""), parameters["Endpoints"]["MediaPlaneDDS"])
