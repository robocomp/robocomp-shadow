...
class Requires:
    def __init__(self, ice_connector):
        ...
        self.AgenteConversacional = self.create_proxy("AgenteConversacionalProxy", RoboCompAgenteConversacional.AgenteConversacionalPrx)
...
class Implements:
    def __init__(self, ice_connector, default_handler):
        self.ice_connector = ice_connector
        self.conversation = self.create_adapter("Conversation", conversationI.ConversationI(default_handler))
