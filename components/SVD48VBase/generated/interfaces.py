...
class Implements:
    def __init__(self, ice_connector:Ice.CommunicatorI, default_handler, parameters):
        ...
        self.differentialrobot = self.create_adapter("DifferentialRobot", differentialrobotI.DifferentialRobotI(default_handler, ""), parameters["Endpoints"]["DifferentialRobot"])
