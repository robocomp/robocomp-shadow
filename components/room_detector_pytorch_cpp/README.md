...
Like any other component, room_detector_pytorch_cpp requires a configuration file to start. In etc/config or etc/config.toml, you can find an example of the configuration file.
...
```bash
cd <room_detector_pytorch_cpp's path> 
...
bin/room_detector_pytorch_cpp etc/yourConfig # Execute the component
```
-----
-----
# Developer Notes
This section explains how to work with the generated code of room_detector_pytorch_cpp, including what can be modified and how to use key features.
## Editable Files
