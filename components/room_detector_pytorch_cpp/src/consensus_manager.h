...
public:
     ...
     * @param detection_covariance Full 3x3 covariance matrix for door pose (x, y, theta)
    ...
    /**
     * @brief Get consensus prior for a door (optimized pose + covariance)
     *
     * This is used by DoorConcept to add a prior term in its loss function.
     *
     * @param door_index Index of the door
     * @return Optional pair of (pose, covariance) if available
     */
