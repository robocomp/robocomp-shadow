...
/** \mainpage RoboComp::room_detector_pytorch_cpp
 *
 * \section intro_sec Introduction
 *
 * The room_detector_pytorch_cpp component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/room_detector_pytorch_cpp --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "room_detector_pytorch_cpp"
#define SERVER_FULL_NAME   "RoboComp room_detector_pytorch_cpp::room_detector_pytorch_cpp"
...
class room_detector_pytorch_cpp : public Ice::Application
{
public:
	room_detector_pytorch_cpp (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData room_detector_pytorch_cpp::getInitializationDataIce(){
...
void room_detector_pytorch_cpp::initialize()
{
...
int room_detector_pytorch_cpp::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	room_detector_pytorch_cpp app(configFile, prefix, startup_check_flag);
